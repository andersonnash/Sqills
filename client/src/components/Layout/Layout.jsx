      ...
      {currentUser ? (
        ...
        <div className=" flex justify-between items-center my-6">
          ...
          {/* <div className='flex justify-end ml-6'> */}
            ...
            <button className=' inline-block mr-20 px-2 py-1 w-5/16 bg-gray-400 hover:bg-blue-600 p-4 rounded-lg text-lg text-gray-900  transition duration-300 mr-4 text-lg font-bold'
