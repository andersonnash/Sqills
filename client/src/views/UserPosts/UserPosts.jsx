              ...
              {currentUser?.id === post.user_id && (
                <div>
                  ...
                  <Link to={`/edit/${post.id}`}>
                    <button className=" inline-block m-4 w-1/3 bg-gray-400 hover:bg-blue-600 p-4 rounded-lg text-xl text-gray-900 font-bold transition duration-300 my-6">
                      Edit
                    </button>
                  </Link>
                  <button
                    className=" inline-block w-1/3  bg-gray-400 hover:bg-blue-600 p-4 rounded-lg text-xl text-gray-900 font-bold transition duration-300"
